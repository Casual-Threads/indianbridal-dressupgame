...
public class Usman_SaveLoad
{
    ...
    public static void SaveProgress()
    {
        ...
        SaveData.Instance.WeddingModeElements, SaveData.Instance.TraditionalModeElements, SaveData.Instance.SahreeModeElements, SaveData.Instance.PopMusicModeElements);
